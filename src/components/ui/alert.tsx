...
const alertVariants = cva(
  "relative w-full rounded-xl border border-border bg-card/85 p-4 backdrop-blur-xl [&>svg~*]:pl-8 [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-foreground",
  {
    variants: {
      variant: {
